/*Q: An arithmetic array is an array that contains at least two integers and the differences
...
int main(){
    ...
    2.current arithematic subarray length = curr  
    3. max arithematic subarray lenght = ans */
    int ans = 2;
    int pd = a[1]=a[0];
    int j = 2;
    int curr = 2;
